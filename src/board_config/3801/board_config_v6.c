...
static const PINMUX_GRP_T pinmuxing[] = {
        ...
        // Board LEDs 
        {4, 5 , (SCU_MODE_FUNC0)}, //blue
        {4, 8 , (SCU_MODE_FUNC4)}, //red

        // UI LEDs
        {1, 17 , (SCU_MODE_FUNC0
                | SCU_MODE_20MA_DRIVESTR)},      // EXT_LED_GREEN
        {2, 4 , (SCU_MODE_FUNC4
                | SCU_MODE_20MA_DRIVESTR)},      // EXT_LED_RED
        ...
        // SD Card
        {4, 9, SCU_MODE_FUNC4},         // SDCARD_POWER_ENABLE
        {1, 6, (SCU_MODE_FUNC7
                | SCU_MODE_INBUFF_EN
...
static const GPIOConfig pin_config[] = {
    ...
    {{0, 12}, GPIO_CFG_DIR_OUTPUT_LOW},     // GPIO_ID_EXT_LED_GREEN
    {{5, 4}, GPIO_CFG_DIR_OUTPUT_LOW},      // GPIO_ID_EXT_LED_RED
    {{5, 16}, GPIO_CFG_DIR_INPUT},          // GPIO_ID_EXT_BUTTON

    {{5, 13}, GPIO_CFG_DIR_OUTPUT_LOW},     // GPIO_ID_SDCARD_POWER_ENABLE
};
