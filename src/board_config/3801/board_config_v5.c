...
static const PINMUX_GRP_T pinmuxing[] = {
        ...
        // UI LEDs
        {2, 2 , (SCU_MODE_FUNC4)},      // EXT_LED_GREEN
        {6, 7 , (SCU_MODE_FUNC4)},      // EXT_LED_RED
...
static const GPIOConfig pin_config[] = {
    ...
    {{5, 2 }, GPIO_CFG_DIR_OUTPUT_LOW},     // GPIO_ID_EXT_LED_GREEN
    {{5, 15}, GPIO_CFG_DIR_OUTPUT_LOW},     // GPIO_ID_EXT_LED_RED
